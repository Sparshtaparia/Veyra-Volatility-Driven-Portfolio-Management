...
def test_normalize_market_data():
    bars = [
        MarketBar(ticker="TCS", timestamp=date(2024,1,2), open=105, high=115, low=100, close=110, volume=2000),
        MarketBar(ticker="TCS", timestamp=date(2024,1,1), open=100, high=110, low=90, close=105, volume=1000),
        MarketBar(ticker="TCS", timestamp=date(2024,1,2), open=106, high=116, low=101, close=111, volume=2100), # Duplicate
    ]
