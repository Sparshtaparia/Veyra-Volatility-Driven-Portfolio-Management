...
const demoUser  = { id: "demo-user",  name: "Sparsh Taparia", email: "user@gmail.com",  role: "INVESTOR" as const }
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const value = useMemo<AuthContextValue>(() => ({
    ...
    signIn: (email, password) => {
      ...
      if (email.trim().toLowerCase() === demoUser.email  && password === "user")  { setUser(demoUser);  return demoUser  }
