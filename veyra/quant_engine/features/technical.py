...
def calculate_macd_histogram(close: pd.Series, fast: int = 12, slow: int = 26, signal_len: int = 9) -> pd.Series:
    """
...
def calculate_bollinger_band_width(close: pd.Series, length: int = 20, num_std: float = 2.0) -> pd.Series:
    """
